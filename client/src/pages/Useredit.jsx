      ...
      <div className='lg:flex lg:flex-row lg:justify-between'>
        ...
        <div className='w-[100%] lg:w-[65%] border border-gray-300 
          ...
          <div className='flex flex-col md:flex-row items-center justify-center md:pt-8 pt-0'>
            ...
            <div className='md:w-[65%] w-[100%] md:py-0 py-1'>
            ...
            <div className='md:w-[35%] w-[100%] gap-2 flex md:justify-end md:pe-8'>
          ...
          <div className='w-full pt-5 md:px-6 px-3'>
            <button className='w-full text-[14px] md:text-[16px] text-white bg-gradient-to-r from-cyan-500 to-blue-500 
                            hover:bg-gradient-to-bl font-medium py-2 rounded-xl cursor-pointer'>
              Save
            </button>
          </div>
